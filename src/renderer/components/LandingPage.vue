    ...
    <main>
      ...
      <div class="right-side">
        <div class="doc">
          ...
          <n-button type="primary" round @click="CheckUpdate('one')">
            {{ $t("buttons.checkUpdate") }}
          </n-button>
        </div>
        <div class="doc">
          <n-button type="primary" round @click="CheckUpdate('two')">
            {{ $t("buttons.checkUpdate2") }}
          </n-button>
          <n-button type="primary" round @click="CheckUpdate('three')">
            {{ $t("buttons.checkUpdateInc") }}
          </n-button>
          <n-button type="primary" round @click="CheckUpdate('threetest')">
            {{ $t("buttons.incrementalUpdateTest") }}
          </n-button>

          <n-button type="primary" round @click="CheckUpdate('four')">
            {{ $t("buttons.ForcedUpdate") }}
          </n-button>
          <n-button type="primary" round @click="StartServer">
            {{ $t("buttons.startServer") }}
          </n-button>
          <n-button type="primary" round @click="StopServer">
            {{ $t("buttons.stopServer") }}
          </n-button>
          <n-button type="primary" round @click="getMessage">
            {{ $t("buttons.viewMessage") }}
          </n-button>
          <n-button type="primary" round @click="crash">
            {{ $t("buttons.simulatedCrash") }}
          </n-button>
          <n-button type="primary" round @click="openPreloadWindow">
            {{ $t("buttons.openPreloadWindow") }}
          </n-button>
        </div>
        <div class="doc">
          <n-button type="primary" round @click="openNewWin">
            {{ $t("buttons.openNewWindow") }}
          </n-button>
          <n-button type="primary" round @click="changeLanguage">{{
            $t("buttons.changeLanguage")
          }}</n-button>
          <n-button type="primary" round @click="printDemo">{{
            $t("buttons.printDemo")
          }}</n-button>
        </div>
      </div>
